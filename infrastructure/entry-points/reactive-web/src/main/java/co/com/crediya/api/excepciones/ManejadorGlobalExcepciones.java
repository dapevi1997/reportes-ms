package co.com.crediya.api.excepciones;
...
@Component
@Order(-2)
public class ManejadorGlobalExcepciones extends AbstractErrorWebExceptionHandler {
    private final Map<Class<? extends Throwable>, HttpStatus> exceptionToHttpStatus = new HashMap<>();

    public ManejadorGlobalExcepciones(ErrorAttributes errorAttributes, WebProperties webProperties, ServerCodecConfigurer codecConfigurer,
                                      ApplicationContext applicationContext) {
        super(errorAttributes, webProperties.getResources(), applicationContext);
        this.setMessageWriters(codecConfigurer.getWriters());
        this.setMessageReaders(codecConfigurer.getReaders());

        exceptionToHttpStatus.put(PeticionMalFormada.class, HttpStatus.BAD_REQUEST);
        exceptionToHttpStatus.put(ServerWebInputException.class, HttpStatus.BAD_REQUEST);
        exceptionToHttpStatus.put(ExcepcionDominio.class, HttpStatus.CONFLICT);
    ...
    private Mono<ServerResponse> renderErrorResponse(ServerRequest request) {
        ...
        return ServerResponse
                ...
                .body(BodyInserters.fromValue(RespuestaErrorDto.builder()
